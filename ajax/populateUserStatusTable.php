...
$sql.= " , AP.PES_STATUS,AP.PES_CLEARED_DATE, AP.ACCOUNT_ID, A.ACCOUNT_TYPE, AP.UPES_REF, AP.PES_REQUESTOR, AP.PES_DATE_REQUESTED,AP.COUNTRY_OF_RESIDENCE, AP.PROCESSING_STATUS, DATEADD(hour, 1, AP.PROCESSING_STATUS_CHANGED) AS PROCESSING_STATUS_CHANGED, AP.PES_RECHECK_DATE ";
